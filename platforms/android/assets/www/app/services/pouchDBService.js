 ...
 */
angular.module('blink.services').factory('$PouchDBService', function ($http, $log) {
...
//function to insert a new record. it's compulsury to have a _id value in json object it should be unique.
    function insert_(dbObj, jsonObj) {
        return dbObj.put(jsonObj);
    }
...
//function to get the db info
    ...
    return {
        ...
        insert: function (dbObj, jsonObj) {
            return insert_(dbObj,jsonObj);
        },
        insertBatchJson: function (dbObj, jsonObj) {
